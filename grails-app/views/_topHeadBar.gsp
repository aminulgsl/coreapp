    ...
    <ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
        ...
        <li>
            <a href="#">
                ...
                <img src="${resource(dir: 'images',file: 'avatar3.png')}" class="msg-photo" alt="Alex's Avatar" />
                <span class="msg-body">
                    <span class="msg-title">
...
<li class="light-blue">
    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
        <img class="nav-user-photo" src="${resource(dir: 'images',file: 'user.png')}" alt="Jason's Photo" />
